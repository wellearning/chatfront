...
export default {
  ...
  methods: {
    ...
    initBlock: function () {
      ...
      this.axios.post('/api/Services/CommerceService.asmx/SearchBlocks', {query: ''}).then(res => {
        if (res) {
    ...
    search: function (name) {
      ...
      this.axios.post('/api/Services/CommerceService.asmx/SearchTemplates', {query: this.searchName}).then(res => {
        if (res) {
          console.log('查询', res)
          this.list = res.data
    ...
    add: function () {
      this.$refs['addForm'].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('/api/Services/CommerceService.asmx/SaveTemplate', {template: JSON.stringify(this.addForm)}).then(res => {
            if (res) {
              console.log('新增', res)
              this.$message({
                type: 'success',
    ...
    showEdit: function (id) {
      this.isLoading = true
      this.axios.post('/api/Services/CommerceService.asmx/GetTemplate', {templateid: id}).then(res => {
        if (res) {
    ...
    edit: function () {
      this.$refs['editForm'].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('/api/Services/CommerceService.asmx/SaveTemplate', {template: JSON.stringify(this.editForm)}).then(res => {
            if (res) {
              console.log('修改', res)
              this.$message({
                type: 'success',
    ...
    del: function (id) {
      this.$confirm('Are you sure to delete it?', 'Confirm', {
        ...
        this.isLoading = true
        this.axios.post('/api/Services/CommerceService.asmx/RemoveTemplate', {templateid: id}).then(res => {
          if (res) {
            console.log('删除', res)
            this.$message({
              type: 'success',
