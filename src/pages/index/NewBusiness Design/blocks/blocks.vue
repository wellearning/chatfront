  ...
  methods: {
    ...
    addChoice: function (form) {
      if (this.currentQuestion === null) {
        ...
        if (form === 'addForm') {
          this.isLoading = true
          this.axios.post('/api/Services/NewBusinessService.asmx/GetQuestion', {questionid: this.currentQuestion}).then(res => {
            if (res) {
    ...
    search: function (name) {
      ...
      this.axios.post('/api/Services/NewBusinessService.asmx/SearchBlocks', {query: this.searchName}).then(res => {
        if (res) {
          console.log('查询', res)
          this.list = res.data
    ...
    add: function () {
      this.$refs['addForm'].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('/api/Services/NewBusinessService.asmx/SaveBlock', {block: JSON.stringify(this.addForm)}).then(res => {
            if (res) {
              console.log('新增', res)
              this.$message({
                type: 'success',
    ...
    showEdit: function (id) {
      this.isLoading = true
      this.axios.post('/api/Services/NewBusinessService.asmx/GetBlock', {blockid: id}).then(res => {
        if (res) {
          console.log('查询单个', res)
    ...
    edit: function () {
      this.$refs['editForm'].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('/api/Services/NewBusinessService.asmx/SaveBlock', {block: JSON.stringify(this.editForm)}).then(res => {
            if (res) {
              console.log('修改', res)
              this.$message({
                type: 'success',
