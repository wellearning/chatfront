<!--
FileName: Configure/address.vue
Author: Ge Chen
Update Date: 2023/9/20
Function: Show all address list and do all operations on the list.
-->
<template>
  <div>
    <div class="inPageTitle">
      <span class="inPageNav">Address</span>
    ...
    <div class="inPageContent">
      <el-table :data="list.slice((currentPage - 1) * pageSize, currentPage * pageSize)" empty-text="No Record" v-loading="isLoading" element-loading-background="rgba(255, 255, 255, 0.5)">
        ...
        <el-table-column label="Address" min-width="300">
    ...
    add: function () {
      this.$refs['addForm'].validate((valid) => {
        if (valid) {
          ...
          this.axios.post('/api/Services/BaseService.asmx/AddDataItem', {datatype: 'Address', name: name, value: name, parentid: 0}).then(res => {
            if (res) {
              console.log('新增', res)
              this.$message({
                type: 'success',
