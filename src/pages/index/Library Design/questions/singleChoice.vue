<!--
FileName: Library/questions/singleChoice.vue
Author: Ge Chen
Update Date: 2023/9/20
Function: Show single choice list and do all operations on the list.
-->
<template>
  <div>
    <div class="inPageTitle">
      <span class="inPageNav">Single Choice for {{businessTypes[btypeId]}}</span>
...
export default {
  ...
  data: function () {
    return {
      isLoading: false,
      currentId: null,
      typeName: ' SingleChoice Question List',
      typeId: 6,
      btypeId: 2,
  ...
  methods: {
    ...
    search: function (name) {
      ...
      this.axios.post('/api/Services/BaseService.asmx/GetQuestionsByTypeQuery', {typeid: 6, query: name, btypeid: this.btypeId}).then(res => {
        if (res) {
          console.log('查询', res)
