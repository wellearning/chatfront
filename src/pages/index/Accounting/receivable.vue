<!--
FileName: Accounting/receivable.vue
Author: Ge Chen
Update Date: 2024/7/1
Function: Provide receivable edition, include new edit delete and query.
-->
<template>
  <div>
    <div class="inPageTitle">
      <span class="inPageNav">Receivable</span>
...
export default {
  ...
  methods: {
    ...
    loadRecords: function () {
      this.isLoading = true
      this.axios.post('/api/Services/CommerceService.asmx/GetTransactionRecords_edit', {type: 'receivable'}).then(res => {
        if (res) {
    ...
    edit: function () {
      this.$refs['editForm'].validate((valid) => {
        if (valid) {
          ...
          // if (this.editForm.Amount < 0) this.editForm.TypeID = 3
          // else this.editForm.TypeID = 1
          this.isLoading = true
