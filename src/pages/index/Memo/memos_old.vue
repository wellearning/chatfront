    ...
    <div class="inPageContent">
      ...
      <el-table :data="list.slice((currentPage - 1) * pageSize, currentPage * pageSize)" empty-text="No Record" v-loading="isLoading || isLoadingInsuranceCompany" element-loading-background="rgba(255, 255, 255, 0.5)">
        ...
        <el-table-column label="Action" width="480" fixed="right">
          <template slot-scope="scope">
            ...
            <el-button icon="el-icon-view" v-if="scope.row.StatusID === 2" type="primary" @click="showSheet(scope.row.MemoID)" :loading="isLoading || isLoadingInsuranceCompany" size="small">FORM</el-button>
      ...
      <el-dialog title="" :visible.sync="viewFormVisible" width="1184.56px" center :before-close="closeView">
        ...
        <div class="viewMemo" id="pdfDom">
          ...
          <img v-if="viewForm.branch.LogoUrl !== ''" class="viewLogo" :src="'/api' + viewForm.branch.LogoUrl + '?time=' + printDate" crossorigin="anonymous">
          <el-row :gutter="20">
            <el-col :span="12">
