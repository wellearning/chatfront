    ...
    <div class="inPageContent">
      ...
      <el-dialog title="" :visible.sync="viewFormVisible" width="1184.56px" center :before-close="closeView">
        ...
        <div class="viewMemo" id="pdfDom">
          ...
          <img v-if="viewForm.branch.LogoUrl !== '' && viewForm.branch.LogoUrl!==null " class="viewLogo" :src="'/api' + viewForm.branch.LogoUrl + '?time=' + printDate" crossorigin="anonymous">
          <el-row :gutter="20">
            <el-col :span="12">
