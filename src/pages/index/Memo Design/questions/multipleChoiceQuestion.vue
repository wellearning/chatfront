        ...
        <el-form :model="addForm" ref="addForm" :rules="addFormRules" class="form choiceQuestionForm">
          ...
          <div v-for="(item, index) in addForm.options" :key="index" class="choice">
            ...
            <el-form-item label="Output">
              <el-input v-model="item.Outputs" clearable></el-input>
            </el-form-item>
            <el-form-item style="margin-left: 20%;">
              ...
              <el-button icon="el-icon-arrow-down" v-if="index !== addForm.options.length - 1" type="primary" @click="downChoice('addForm', index)" :loading="isLoading" plain size="small" style="float: right;"></el-button>
            </el-form-item>
            <el-form-item style="margin-left: 20%;">
        ...
        <el-form :model="editForm" ref="editForm" :rules="editFormRules" class="form choiceQuestionForm">
          ...
          <div v-for="(item, index) in editForm.options" :key="index" class="choice">
            ...
            <el-form-item style="margin-left: 20%;">
              ...
              <el-button icon="el-icon-arrow-down" v-if="index !== editForm.options.length - 1" type="primary" @click="downChoice('editForm', index)" :loading="isLoading" plain size="small" style="float: right;"></el-button>
            </el-form-item>
            <el-form-item style="margin-left: 20%;">
...
export default {
  ...
  methods: {
    ...
    search: function (name) {
      this.isLoading = true
      this.axios.post('/api/Services/memoservice.asmx/GetQuestionsByType', {typeid: 7}).then(res => {
        if (res) {
          console.log('查询', res)
