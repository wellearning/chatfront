      ...
      <table>
        ...
        <tr style="letter-spacing: 0px;">
          <td rowspan="9" colspan="3" style="line-height: 20px;"><div style="font-weight: bolder; text-align: center;">COMMERCIAL GENERAL LIABILITY</div>
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.CLAIMS_MADE" /> CLAIMS MADE <span style="padding:0 5px;font-weight:bolder;">OR</span>
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.OCCURRENCE"/> OCCURRENCE
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.Operations" /> PRODUCTS AND/OR COMPLETED OPERATIONS
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.Employers"/> EMPLOYER'S LIABILITY
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.Cross" /> CROSS LIABILITY
            <br>
            <br>
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.WAIVER" /> WAIVER OF SUBROGATION
            <br>
            <br>
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.TENANTS"/> TENANTS LEGAL LIABILITY
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.POLLUTION"/> POLLUTION LIABILITY EXTENSION
        ...
        <tr>
          <td colspan="2" style="line-height: 12px;"><input type="checkbox" v-model="csio.part4.generalLiability.limitOfLiability.personalInsury" /> PERSONAL INSUARY LIABILITY
            OR
        ...
        <tr>
          <td colspan="3">
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.NONOWNED" /> NON-OWNED AUTOMOBILES
          </td>
          <td colspan="3"></td>
          <td colspan="2"></td>
          <td colspan="2"></td>
        ...
        <tr>
          <td colspan="3">
            <input type="checkbox" v-model="csio.part4.generalLiability.liability.HIRED"/> HIRED AUTOMOBILES
          </td>
          <td colspan="3"></td>
          <td colspan="2"></td>
          <td colspan="2"></td>
        ...
        <tr style="letter-spacing: 0px;">
          <td rowspan="4" colspan="3"><div style="font-weight: bolder; text-align: left;">AUTOMOBILE LIABILITY</div>
            <input type="checkbox" v-model="csio.part4.automobileLiability.liability.DESCRIBED" /> DESCRIBED AUTOMOBILES
            <input type="checkbox" v-model="csio.part4.automobileLiability.liability.ALLOWED"/> ALLOWED AUTOMOBILES
            <input type="checkbox" v-model="csio.part4.automobileLiability.liability.LEASED"/> LEASED AUTOMOBILES**
        ...
        <tr style="letter-spacing: 0px;">
          <td rowspan="3" colspan="3"><div style="font-weight: bolder; text-align: left;">EXCESS LIABILITY</div>
            <input type="checkbox" v-model="csio.part4.excessLiability.liability.UmbrellaForm"/> UMBRELLA FORM
            <input type="checkbox" v-model="csio.part4.excessLiability.liability.OtherType"/>
          </td>
        ...
        part4: {
          generalLiability: {
            ...
            limitOfLiability: {
              ...
              personalAdvertisingInjury: false,
              generalAggregate: {
                ded: '',
                amount: ''
              },
